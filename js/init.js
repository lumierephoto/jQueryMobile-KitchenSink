...
// GLOBAL VARS
var my_client_id = "155223874595014", // YOUR APP ID
	my_secret = "ee038d5c331b8eefff1c601fcce90f2a", // YOUR APP SECRET 
...
var Facebook = {
	...
	facebookLocChanged:function(loc){
		...
		if (loc.indexOf("https://www.facebook.com/connect/login_success.html") > -1) {
			...
			$.ajax({
				url:'https://graph.facebook.com/oauth/access_token?client_id='+my_client_id+'&client_secret='+my_secret+'&code='+fbCode+'&redirect_uri=https://www.facebook.com/connect/login_success.html',
				data: {},
				dataType: 'text',
				type: 'POST',
...
var app = {
	...
	createPost:function(){
		...
		var params = {};
			params['message'] = msg;
			params['name'] = 'Paul Cisneros Photography App for iPhone/iPad is now available!';
			params['description'] = "Download the FREE app in the App Store.";
            params['link'] = "http://apps.facebook.com/paul-cisneros-photo";
            params['picture'] = "http://www.paulcisneros.com/images/app_icon.png";
			params['caption'] = '';
